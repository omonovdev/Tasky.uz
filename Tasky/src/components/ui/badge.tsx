  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow-sm",
  {
    variants: {
      variant: {
        ...
        pending: "border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80 hover:shadow-md",
        inProgress: "border-transparent bg-warning text-warning-foreground hover:bg-warning/80 hover:shadow-md",
        completed: "border-transparent bg-success text-success-foreground hover:bg-success/80 hover:shadow-md",
      },
    },
    defaultVariants: {
      variant: "default",
